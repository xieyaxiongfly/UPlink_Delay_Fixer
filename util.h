...
void min_in_array_uint64_vi(uint64_t *array, int array_size, uint64_t *val,
                            int *idx);
void max_in_array_uint64_vi(uint64_t *array, int array_size, uint64_t *val,
                            int *idx);
void min_in_array_uint16_vi(uint16_t *array, int array_size, uint16_t *val,
                            int *idx);
void max_in_array_uint16_vi(uint16_t *array, int array_size, uint16_t *val,
                            int *idx);
...
uint64_t nearest_neighbour_w_offset(uint64_t *array, int array_size,
                                    uint64_t num, int offset);
long nearest_neighbour_dist_w_offset(uint64_t *array, int array_size,
                                     uint64_t num, int offset);

long correlate_2_vec(uint64_t *array1, uint64_t *array2, int array_size1,
                     int array_size2);
long correlate_2_vec_w_offset(uint64_t *array1, uint64_t *array2,
                              int array_size1, int array_size2, int offset);
